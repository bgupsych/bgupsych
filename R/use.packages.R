...
#' @description Allows you to install and call from memory multiple packages at once.
...
#' use.package(my_pack,library.only=FALSE) # This will re-install these packages, and you will be asked to restart R.
